...
复用本轮 37 条已保存输出比较 8／16／32 像素羽化后，16 像素被选为 v6 默认：它在
33/33 条有 Generate 边界的样本上降低边界梯度误差，UVG 平均 LPIPS 降低 0.000866；
合并 LPIPS 的代价为 0.001702，明显小于 32 像素的 0.005303。Jockey 的背景误生成仍在，
说明更宽羽化不能替代路由修正。完整结果见
